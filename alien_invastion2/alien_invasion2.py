...
class AlienInvasion:
    ...
    def _update_bombs(self):
        ...
        # Get rid of bombs that have disappeared off the screen.
    ...
    def _check_bomb_ship_collisions(self):
        """Respond to bomb-ship collisions."""
        # Check for any bombs that have hit the ship.
        # If so, get rid of the bomb and the ship.
    ...
    def _create_fleet(self):
        ...
        available_space_y = (self.settings.screen_height - (3 * alien_hieght) - ship_height)
        number_rows = available_space_y // int(1.5 * alien_hieght)
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien.rect.y = alien_hieght + 2 * alien_hieght * row_number
